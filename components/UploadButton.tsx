...
const UploadButton: React.FC<UploadButtonProps> = ({ onClick }) => {
  return (
    <button
      onClick={onClick}
      className="fixed bottom-6 right-6 md:bottom-8 md:right-8 z-20 w-14 h-14 md:w-16 md:h-16 bg-gray-950 text-gray-300 rounded-full flex items-center justify-center 
